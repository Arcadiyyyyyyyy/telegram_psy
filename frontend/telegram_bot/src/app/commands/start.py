...
async def notify_about_the_pipeline(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    message = await context.bot.send_message(
        ...
        "Для прохождения тестов нужно выделить время в тихом месте, где ты сможешь сконцентрироваться. \n"  # noqa
        "На тест iq вам понадобится около 10 минут, на тест atq — около 20. \n"
